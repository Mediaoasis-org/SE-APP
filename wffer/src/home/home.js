		...
		return(
				<View style={gstyles.container}>
					...
					<View style={{width:'100%',flexDirection:'row'}}>
						<FlatList numColumns={2} data={[{id: '1',name:'Puck Cream Cheese Spread 500 g',discount:'40% Off',company:'Panda',category:'Dairy',price:'15.70 SAR',discountedPrice:'9.48 SAR',image:'product1.jpg'}, 
														{id: '2',name:'Almarai Mozzarella Shredded Cheese 200 g  ',discount:'36% Off',company:'Panda',category:'Dairy',price:'9.40 SAR',discountedPrice:'5.98 SAR',image:''}]}
			                renderItem={({item}) =>      
			                    <View style={{width: '50%',padding:15}}>
			                      <TouchableOpacity style={{alignItems:'center'}}><Image source={require('../../assets/product1.jpg')} style={gstyles.flatimage}/></TouchableOpacity>
			                          <View style={{flexDirection: 'column'}}>
			                          	  <Text style={{width:'60%',marginTop:10,backgroundColor:'#c30000',padding:5,color:'#fff'}}>{item.discount} </Text>
