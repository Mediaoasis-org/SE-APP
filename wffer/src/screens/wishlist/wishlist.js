				...
				<View style={gstyles.container}>
					...
					<ScrollView>
						...
						<View style={{width:'100%',flexDirection:'row'}}>
							...
							<TouchableOpacity onPress={()=>this.props.navigation.goBack()} style={{margin:10,padding:10,borderColor:'#696969',borderWidth:1,alignItems:'center'}}><Text style={{color:'#000',fontSize:16,fontWeight:'bold'}}>Get Price</Text></TouchableOpacity>
					</ScrollView>
					{
