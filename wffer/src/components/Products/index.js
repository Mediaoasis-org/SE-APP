...
export class ProductDetail extends React.Component{
  ...
  render(){
      return(
        ...
        <View style={{flexDirection:'row',width:'100%'}}><TouchableOpacity style={gstyles.likeButton}><Text style={{textAlign:'center'}}>Like</Text></TouchableOpacity><TouchableOpacity style={gstyles.likeButton}><Text style={{textAlign:'center'}}>Add to Shopping List</Text></TouchableOpacity> </View>
        </View>
        )
      }
  }
